...
export const SURFACE_INVENTORY: SurfaceRow[] = [
  ...
  { route: "/admin/clients/:clientId/five9-overlay", scope: "org-admin", file: "App.tsx <Navigate to=\"/admin/campaigns\" />", currentTitle: "(redirect → /admin/campaigns)", canonicalName: "(retired)", classification: "redirecting", action: "delete", slice: "D", risk: "low", notes: "Phase D: file deleted, link removed from ClientOverviewPage, route silent-redirects." },
  { route: "/admin/clients/:clientId/five9-overlay/campaigns/:campaignRouteId", scope: "org-admin", file: "App.tsx <Navigate to=\"/admin/campaigns\" />", currentTitle: "(redirect → /admin/campaigns)", canonicalName: "(retired)", classification: "redirecting", action: "delete", slice: "D", risk: "low", notes: "Phase D: file deleted." },
  ...
  { route: "/admin/automations", scope: "org-admin", file: "App.tsx <WorkspaceResolveRedirect to=\"/w/:workspaceId/notifications\" />", currentTitle: "(redirect → /w/:workspaceId/notifications)", canonicalName: "Post-call rules (workspace tab)", classification: "redirecting", action: "redirect", slice: "D", risk: "low", notes: "Phase D: PostCallAutomationsContent now mounted as the Post-call rules tab inside WorkspaceNotificationsPage. Admin file retained as a re-export only." },
  { route: "/admin/ani-blocklist", scope: "org-admin", file: "App.tsx <Navigate to=\"/admin/settings\" />", currentTitle: "(redirect → /admin/settings)", canonicalName: "(retired)", classification: "redirecting", action: "delete", slice: "D", risk: "low", notes: "Phase D: file deleted, route silent-redirects." },
  { route: "/admin/callback-queue", scope: "org-admin", file: "App.tsx <Navigate to=\"/admin/settings\" />", currentTitle: "(redirect → /admin/settings)", canonicalName: "(retired)", classification: "redirecting", action: "delete", slice: "D", risk: "low", notes: "Phase D: file deleted." },
  { route: "/admin/abandon-rate", scope: "org-admin", file: "App.tsx <Navigate to=\"/admin/settings\" />", currentTitle: "(redirect → /admin/settings)", canonicalName: "(retired)", classification: "redirecting", action: "delete", slice: "D", risk: "low", notes: "Phase D: file deleted." },
  ...
  { route: "/admin/qr-routing", scope: "org-admin", file: "App.tsx <Navigate to=\"/admin/settings\" />", currentTitle: "(redirect → /admin/settings)", canonicalName: "(retired)", classification: "redirecting", action: "delete", slice: "D", risk: "low", notes: "Phase D: file deleted." },
