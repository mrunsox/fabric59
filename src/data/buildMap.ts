...
export const buildMap: BuildCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "QR Code Inbound Routing", description: "Map inbound QR DIDs to tenant callback routing configs for source_channel=qr_code tracking", status: "done" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Tenant Testing Framework", description: "Test plans/runs tables, legal-connect-test edge function, Testing tab UI, and AI-generated test plan support", status: "done" },
      ...
      { name: "Example Library & Seed Data", description: "Examples table with ~30 seeded scenarios for Clio webhooks, Five9 call-driven flows, MyCase capabilities, and review queue cases", status: "done" },
      { name: "AI Prompt Pack System", description: "Prompt templates table with ~15 seeded admin and agent prompts, editable templates, version history, and preview mode", status: "done" },
      { name: "AI Edge Function (legal-connect-ai)", description: "Prompt executor with context merging, Lovable AI gateway integration, safety rules, and session persistence", status: "done" },
      { name: "Agent Context Panel", description: "Compact agent-facing component with AI-generated call context summary, intake checklist, and disposition hints", status: "done" },
      ...
      { name: "Go-Live Readiness & Rollout Tools", description: "Readiness checklist, rollout risk analysis, post-launch monitoring, and AI-powered go-live review", status: "done" },
    ],
  },
  ...
  // ── Sprint B: AI Assistant + Guardrails ──
  {
    ...
    items: [
      { name: "Floating Chat Button", description: "Bottom-right chat button for logged-in users that opens an AI assistant panel", status: "done" },
      { name: "Assistant Panel with KB Grounding", description: "Chat panel with responses grounded in knowledgeBase.ts and buildMap features", status: "done" },
      { name: "System Prompt with Guardrails", description: "/prompts/assistant-system.txt with identity, scope, safety, and escalation rules", status: "done" },
      { name: "Tenant-Configurable Assistant", description: "Per-tenant settings for assistant name, avatar, description, and enabled toggle", status: "done" },
      { name: "Contextual Help Icons", description: "Help icons on complex pages linking to KB articles or prefilled assistant questions", status: "done" },
    ],
  },
  // ── Privacy & Trust ──
  {
  ...
  // ── Sprint C: Marketing Expansion ──
  {
    ...
    items: [
      { name: "Product Tour Page", description: "Deep /product page with interactive walkthrough of key features", status: "done" },
      { name: "Interactive Demo Sandbox", description: "/demo page with read-only mini app using mock data for guided exploration", status: "done" },
      { name: "Standalone FAQ Page", description: "Dedicated /faq route with categorized questions and search", status: "done" },
      { name: "Sticky Header on Scroll", description: "Condensed header with backdrop blur that persists on scroll", status: "done" },
      { name: "Before/After Interactive Module", description: "Draggable slider showing workflow transformation from manual to Fabric59", status: "done" },
      { name: "Persona Tabs Module", description: "Choose your role tabs that swap hero copy and visuals for BPO, legal, home services", status: "done" },
      { name: "Live Product Visual in Hero", description: "Animated or interactive mini UI in the hero section showing real product capabilities", status: "done" },
    ],
  },
  // ── Sprint D: Notifications + Import/Export ──
  {
    ...
    items: [
      { name: "Notification Bell in Header", description: "Bell icon with unread badge in app header, dropdown list of recent notifications", status: "done" },
      { name: "CSV Export for Main Entities", description: "Export buttons on agents, tenants, campaigns, and call logs tables", status: "done" },
      { name: "Import Wizard Component", description: "Upload, column mapping, validation, and safe write flow for bulk data imports", status: "done" },
      { name: "Lifecycle Email Templates", description: "Welcome, trial, billing, and update email templates via Resend", status: "planned" },
      { name: "Webhook Event Layer", description: "Structured event bus for key actions (call ended, agent provisioned, invoice created) with hook support", status: "done" },
    ],
  },
  // ── Sprint E: Onboarding Polish ──
  {
    ...
    items: [
      { name: "AI-Recommended Setup Defaults", description: "Use onboarding intent answers to suggest optimal initial configuration", status: "done" },
      { name: "Invite Team Step", description: "Onboarding step to invite teammates with role suggestions based on org size", status: "done" },
      { name: "Getting Started Dashboard Widget", description: "Persistent checklist widget on main dashboard until key steps are completed", status: "done" },
      { name: "Onboarding Restart from Settings", description: "Option in settings or /help to reopen or reset the onboarding flow", status: "done" },
    ],
  },
  // ── Sprint F: Prompt Governance ──
  {
    ...
    items: [
      { name: "Prompts Directory", description: "/prompts directory with centralized prompt library listing major prompts with title, description, and version", status: "done" },
      { name: "Prompt Change Tracking", description: "Short change notes when prompts are modified, with version history", status: "done" },
      { name: "Safety-Labeled Prompts", description: "Clear labeling for prompts that affect security, trust, or user-facing behavior", status: "done" },
    ],
  },
