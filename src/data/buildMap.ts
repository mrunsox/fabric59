...
export const buildMap: BuildCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "CRM Push Logic", description: "Send mapped data to tenant CRM systems", status: "done" },
      { name: "Webhook Support", description: "Receive real-time events from Five9", status: "done" },
    ],
  },
  {
    ...
    items: [
      ...
      { name: "Error Alerting", description: "Email/Slack alerts for critical failures", status: "done" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Integration Configure Flow", description: "End-to-end setup wizard for each integration", status: "done" },
      { name: "Live API Connection Testing", description: "Test integration credentials before saving", status: "done" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Slack Invite / Remove", description: "Wire real Slack API for onboarding/offboarding steps", status: "done" },
      { name: "Data Transfer Step", description: "Google Drive Transfer API for offboarding step 1", status: "done" },
      { name: "HR Notification Email", description: "Resend email confirming offboarding completion to HR", status: "done" },
      { name: "Cron Trigger for process-jobs", description: "pg_cron scheduled job every 30 minutes", status: "done" },
    ],
  },
  {
