...
import { CrmIntegrationWizard } from "@/components/tenants/CrmIntegrationWizard";
...
export function TenantForm({ tenant, onSuccess }: TenantFormProps) {
  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
      ...
      <CrmIntegrationWizard
        tenantId={tenant?.id}
        configs={form.watch("integration_configs") as any || {}}
        onChange={(configs) => form.setValue("integration_configs", configs as any)}
      />
