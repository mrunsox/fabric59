...
/**
 * Phase H — Concierge onboarding shell.
 *
 * Brand bar + progress rail + step header + body slot + footer nav.
 * Token-only premium framing. Workspace-first by default — never
 * implies admin as the first destination.
 */
