...
/**
 * Phase 2 — Canonical AuthShell.
 *
 * Promoted from re-export to the real implementation. Two-pane on desktop,
 * stacked on mobile. Left pane = brand + grounded product truth (no rotating
 * feature lists, no fabricated security chips). Right pane = clean form.
 *
 * Used by /login, /signup, /forgot-password, /reset-password, /accept-invite.
 * Auth pages should import from "@/shells/AuthShell".
 */
