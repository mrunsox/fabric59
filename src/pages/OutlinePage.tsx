...
const PHASES: { id: string; name: string; status: Status; objectives: string; exit: string }[] = [
  ...
  },
  {
    ...
    objectives: "Mount canonical /app/workspaces/:workspaceId/* shell with canonical workspace nav, breadcrumbs, switcher; reuse legacy pages where safe; placeholders elsewhere; no DB changes.",
...
const FREEZE_CHECKLIST: { id: string; label: string; status: Status }[] = [
  ...
  { id: "p11-builder-vault", label: "Phase 11 follow-up — legacy guide-builder source files (scripter, scriptflow hub, tree editor, call-flow builder) retired in Phase 1 Fabric59 reposition; routes still redirect", status: "done" },
  ...
  { id: "pb-imports-vault", label: "QA Phase B — legacy campaign-tab source files (campaigns overview, drafts, archived list, blueprints) retired in Phase 1 Fabric59 reposition; routes still redirect", status: "done" },
...
Status:    open | in-progress | fixed | wontfix | duplicate`}
              ...
              <ul className="list-disc pl-5 space-y-1 text-xs">
                ...
                <li>Legacy source files removed in Phase 1 Fabric59 reposition: scripter, scriptflow hub, call-flow builder, legacy integrations page, legacy campaign-tab pages (<span className="font-mono">p11-builder-vault</span> + <span className="font-mono">pb-imports-vault</span> done).</li>
